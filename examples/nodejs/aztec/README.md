...
This example repository allows you to generate any type of Aztec barcodes. You can find more information on our [Barcode Bakery website](https://www.barcodebakery.com).

This is based on the [barcode Aztec](https://github.com/barcode-bakery/barcode-typescript/tree/master/ts/aztec) library.
...
```bash
$ npm install @barcode-bakery/barcode-aztec @barcode-bakery/barcode-common @barcode-bakery/barcode-nodejs-common
```

or

```bash
$ yarn add @barcode-bakery/barcode-aztec @barcode-bakery/barcode-common @barcode-bakery/barcode-nodejs-common
```
...
Have a look at the file [app-aztec.js](https://github.com/barcode-bakery/barcode-typescript/blob/master/examples/nodejs/aztec/src/app-aztec.js) then call:

```bash
node src/app-aztec.js
```

TypeScript examples such as [app-aztec.ts](https://github.com/barcode-bakery/barcode-typescript/blob/master/examples/nodejs/aztec/ts/app-aztec.ts) are also supplied:

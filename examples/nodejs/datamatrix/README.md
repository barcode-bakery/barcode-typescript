...
This example repository allows you to generate any type of DataMatrix barcodes. You can find more information on our [Barcode Bakery website](https://www.barcodebakery.com).

This is based on the [barcode DataMatrix](https://github.com/barcode-bakery/barcode-typescript/tree/master/ts/datamatrix) library.
...
```bash
$ npm install @barcode-bakery/barcode-datamatrix @barcode-bakery/barcode-common @barcode-bakery/barcode-nodejs-common
```

or

```bash
$ yarn add @barcode-bakery/barcode-datamatrix @barcode-bakery/barcode-common @barcode-bakery/barcode-nodejs-common
```
...
Have a look at the file [app-datamatrix.js](https://github.com/barcode-bakery/barcode-typescript/blob/master/examples/nodejs/datamatrix/src/app-datamatrix.js) then call:

```bash
node src/app-datamatrix.js
```

TypeScript examples such as [app-datamatrix.ts](https://github.com/barcode-bakery/barcode-typescript/blob/master/examples/nodejs/datamatrix/ts/app-datamatrix.ts) are also supplied:

```bash
tsx ts/app-datamatrix.ts
```

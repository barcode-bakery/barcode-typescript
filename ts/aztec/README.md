...
- [NodeJS](https://github.com/barcode-bakery/barcode-typescript/examples/nodejs/aztec)
- [React](https://github.com/barcode-bakery/barcode-typescript/examples/react/aztec)

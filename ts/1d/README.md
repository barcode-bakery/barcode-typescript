...
- [NodeJS](https://github.com/barcode-bakery/barcode-typescript/examples/nodejs/1d)
- [React](https://github.com/barcode-bakery/barcode-typescript/examples/react/1d)

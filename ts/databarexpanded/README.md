...
- [NodeJS](https://github.com/barcode-bakery/barcode-typescript/examples/nodejs/databarexpanded)
- [React](https://github.com/barcode-bakery/barcode-typescript/examples/react/databarexpanded)

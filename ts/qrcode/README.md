...
- [NodeJS](https://github.com/barcode-bakery/barcode-typescript/examples/nodejs/qrcode)
- [React](https://github.com/barcode-bakery/barcode-typescript/examples/react/qrcode)
